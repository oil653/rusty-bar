...
This version is for my own app, and it just needs to work with the iced 0.15.0-dev (commit c2646f6).
I just made it good enough to work, you should probably not use this.
